...
void setup() {
  ...
  A = loadImage ("Escena 1.jpg");
  B = loadImage ("Escena 2.jpg");
  C = loadImage ("Escena 3.jpg");
  D = loadImage ("Escena 4.jpg");
  E = loadImage ("Escena 5.jpg");
  F = loadImage ("Escena 6.jpg");
  G = loadImage ("Escena 7.jpg");
  H = loadImage ("Escena 8.jpg");
  I = loadImage ("Escena 9.jpg");
  J = loadImage ("Escena 10.jpg");
  K = loadImage ("Escena 11.jpg");
  L = loadImage ("Escena 12.jpg");
  M = loadImage ("Escena 13.jpg");
  N = loadImage ("Escena 14.jpg");
  O = loadImage ("Escena 15.jpg");
  P = loadImage ("Escena 16.jpg");
  Q = loadImage ("Escena 17.jpg");
...
void draw () {
  ...
  image ( A, 0, 0 );
  txt( relato[1], width/2, 200, 25, CENTER, 0);
  ...
  image ( B, 0, 0 );
  txt( relato[2], width/2, 350, 25, CENTER, 0);
  ...
  image ( C, 0, 0 );
  txt( relato[3], width/2, 350, 25, CENTER, 0);
  ...
  image ( D, 0, 0 );
  txt( relato[4], width/2, 350, 25, CENTER, 0);
  ...
  image ( F, 0, 0 );
  txt( relato[5], width/2, 350, 25, CENTER, 0);
  ...
  image ( E, 0, 0 );
  txt( relato[6], width/2, 350, 25, CENTER, 0);
  ...
  txt( relato[7], width/2, 350, 25, CENTER, 0);
  ...
  image ( G, 0, 0 );
  txt( relato[8], width/2, 350, 25, CENTER, 0);
  ...
  image ( G, 0, 0 );
  txt( relato[9], width/2, 350, 25, CENTER, 0);
  ...
  txt( relato[10], width/2, 350, 25, CENTER, 0);
  ...
  image ( H, 0, 0 );
  txt( relato[11], width/2, 350, 25, CENTER, 0);
  rect ( 300, 550, 100, 50 );
  pushStyle();
  fill ( 0 );
  textAlign ( CENTER, CENTER );
  ...
  image ( I, 0, 0 );
  txt( relato[12], width/2, 350, 25, CENTER, 0);
  ...
  image ( J, 0, 0 );
  txt( relato[13], width/2, 350, 25, CENTER, 0);
  ...
  image ( K, 0, 0 );
  txt( relato[14], width/2, 350, 25, CENTER, 0);
  ...
  image ( L, 0, 0 );
  txt( relato[15], width/2, 250, 25, CENTER, 0);
  ...
  image ( O, 0, 0 );
  txt( relato[16], width/2, 200, 25, CENTER, 0);
  rect ( 300, 550, 100, 50 );
  pushStyle();
  fill ( 0 );
  textAlign ( CENTER, CENTER );
  ...
  image ( M, 0, 0 );
  txt( relato[17], width/2, 350, 25, CENTER, 0);
  ...
  image ( N, 0, 0 );
  txt( relato[18], width/2, 350, 25, CENTER, 0);
  ...
  image ( P, 0, 0 );
  txt( relato[19], width/2, 350, 25, CENTER, 0);
  rect ( 300, 550, 100, 50 );
  pushStyle();
  fill ( 0 );
  textAlign ( CENTER, CENTER );
  ...
  image ( Q, 0, 0 );
  txt( relato[20], width/2, 350, 25, CENTER, 0);
  rect ( 300, 550, 100, 50 );
  pushStyle();
  fill ( 0 );
  textAlign ( CENTER, CENTER );
